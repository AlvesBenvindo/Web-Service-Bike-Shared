package ao.uan.fc.cc4.bikeshared.Station2.endpoint.dock.service;

import java.util.List;
import java.util.Optional;

import ao.uan.fc.cc4.bikeshared.Station2.bd.dock.DockRepository;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import ao.uan.fc.cc4.bikeshared.Station2.bd.DataFixed.Model;
import ao.uan.fc.cc4.bikeshared.Station2.bd.DataFixed.ModelRepository;
import ao.uan.fc.cc4.bikeshared.Station2.bd.dock.DockModel;
...
public class DockService {
    ...
    public GetStationResponse getStationData (GetStationRequest request) {
        ...
        if (!dockList.isEmpty()) {
            ...
            response.setMensagem("Esta estação não tem docas registradas!!!");
        }
